    ...
    >
      ...
      <div className="flex flex-col">
        ...
        <div className="mt-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <span className="text-sm text-chrome/80">{thread.comments} comments</span>
          <button className="rounded-md border border-chrome/35 px-4 py-2 text-sm font-semibold text-chrome transition hover:border-chrome hover:bg-chrome hover:text-black hover:shadow-silver">
            View Thread
          </button>
        </div>
      </div>
